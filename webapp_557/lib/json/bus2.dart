...
class BusDetail2 extends StatefulWidget {
  @override
  BusDetail2State createState() => new BusDetail2State();
}

class BusDetail2State extends State<BusDetail2> {
  List data;
  Future getData() {
    return DefaultAssetBundle.of(context).loadString('assets/bus_detail_go.json');
  }
  // Timer timer;
  @override
  // 如果畫面放著不管20秒更新一次
  // void initState() {
  //   super.initState();
  //   timer = Timer.periodic(Duration(seconds: 5), (Timer t)=>refreshPage());
  // }
  // void refreshPage() {
  //   setState(() {
